IMAGE?=khulnasoft/vul-docker-extension
TAG?=latest
...
.PHONY: build-dev
build-dev:
	@DOCKER_BUILDKIT=1 docker build -t vul-docker-extension:development .
...
.PHONY: dev-reset
dev-reset:
	@docker extension dev reset vul-docker-extension:development
